...
void solve()
{
    ...
    while(sc1(s))
    {
        if(s == "#") break;
        PR "Case "<< ++c <<": ";
        if(s == "HELLO") PR "ENGLISH\n";
        else if(s == "HOLA") PR "SPANISH\n";
        else if(s == "HALLO") PR "GERMAN\n";
        else if(s == "BONJOUR") PR "FRENCH\n";
        else if(s == "CIAO") PR "ITALIAN\n";
        else if(s == "ZDRAVSTVUJTE") PR "RUSSIAN\n";
        else PR "UNKNOWN\n";
    }
}
/* Solution Ends */
